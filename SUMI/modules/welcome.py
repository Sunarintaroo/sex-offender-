...
from SUMI.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from SUMI.modules.helper_funcs.misc import (
    build_keyboard,
    paginate_modules,
    revert_buttons,
)
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_photo(
                    SUMI_DIS_WEL,
                    caption="Be cool! one of the devs just joined.",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_photo(
                    SUMI_RESP,
                    caption="Ohh damn, Legend Arrives\nHow are you sir",
                    reply_to_message_id=reply,
                )
                continue
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text="Support", url="t.me/AsukaSupport"
                            ),
                        ]
                    ]
                ),
